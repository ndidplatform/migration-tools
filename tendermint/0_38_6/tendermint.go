...
import (
	...
	"github.com/ndidplatform/migration-tools/tendermint/0_38_6/state"
	sm "github.com/ndidplatform/migration-tools/tendermint/0_38_6/state"
	"github.com/ndidplatform/migration-tools/tendermint/0_38_6/store"
)
...
func GetTendermintInfo(tmHome string) (tendermintStateInfo *TendermintStateInfo, err error) {
	...
	blockMeta := blockStore.LoadBlockMeta(state.LastBlockHeight)
