...
import (
	...
	storeTm "github.com/tendermint/tendermint/store"
	dbm "github.com/tendermint/tm-db"

	"github.com/ndidplatform/migration-tools/backup_v5/utils"
)
...
func getLastestTendermintData() (chainData chainHistoryDetail) {
	...
	blockStore := storeTm.NewBlockStore(blockDB)
...
func readStateDBAndWriteToFile(curChain chainHistoryDetail) {
	...
	ndidNodeID, err := db.Get([]byte("MasterNDID"))
	if err != nil {
		panic(err)
	}
	totalKV := 0
